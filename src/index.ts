/* eslint-disable max-lines -- TODO: refactor — extract AppState, IdleTimer, AttachmentBuffer, SessionTracker */
import fs from 'fs';
...
async function processGroupMessages(chatJid: string): Promise<boolean> {
  ...
  const output = await runAgent(group, prompt, chatJid, parsedModel, attachments, async (result) => {
